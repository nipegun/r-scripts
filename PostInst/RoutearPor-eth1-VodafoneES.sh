...
if [ $OS_VERS == "7" ]; then
  ...
  echo ""
  echo "------------------------------------------------------------------------------------------"
  echo "  Iniciando el script de preparación para conectar 10 (Buster) con la ONT de Vodafone..."
  echo "------------------------------------------------------------------------------------------"
  echo ""
  ...
  echo ""
  echo "--------------------------------------------------------------------------------------------"
  echo "  Iniciando el script de preparación para conectar 10 (Bullseye) con la ONT de Vodafone..."
  echo "--------------------------------------------------------------------------------------------"
  echo ""
