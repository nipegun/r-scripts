...
if [ $OS_VERS == "7" ]; then
  ...
  echo ""
  echo "--------------------------------------------------------------------------------------"
  echo "  Iniciando el script de preparación de Debian 7 (Wheezy) para que routee por br0..."
  echo "--------------------------------------------------------------------------------------"
  echo ""
  ...
  echo ""
  echo "--------------------------------------------------------------------------------------"
  echo "  Iniciando el script de preparación de Debian 8 (Jessie) para que routee por br0..."
  echo "--------------------------------------------------------------------------------------"
  echo ""
  ...
  echo ""
  echo "---------------------------------------------------------------------------------------"
  echo "  Iniciando el script de preparación de Debian 9 (Stretch) para que routee por br0..."
  echo "---------------------------------------------------------------------------------------"
  echo ""
    ...
    do
      case $choice in
        ...
        4)
          ...
          echo ":OUTPUT ACCEPT [0:0]"                                                                   >> /root/ReglasIPTablesV4RouterEthernetWiFi
          echo ":POSTROUTING ACCEPT [0:0]"                                                              >> /root/ReglasIPTablesV4RouterEthernetWiFi
          echo "-A POSTROUTING -o $vInterfazWAN -j MASQUERADE"                                          >> /root/ReglasIPTablesV4RouterEthernetWiFi
          echo "COMMIT"                                                                                 >> /root/ReglasIPTablesV4RouterEthernetWiFi
          echo ""                                                                                       >> /root/ReglasIPTablesV4RouterEthernetWiFi
          ...
          echo ":FORWARD ACCEPT [0:0]"                                                                  >> /root/ReglasIPTablesV4RouterEthernetWiFi
          echo ":OUTPUT ACCEPT [0:0]"                                                                   >> /root/ReglasIPTablesV4RouterEthernetWiFi
          echo "-A FORWARD -i $vInterfazWAN -o br0 -m state --state RELATED,ESTABLISHED -j ACCEPT"      >> /root/ReglasIPTablesV4RouterEthernetWiFi
          echo "-A FORWARD -i br0 -o $vInterfazWAN -j ACCEPT"                                           >> /root/ReglasIPTablesV4RouterEthernetWiFi
          echo "COMMIT"                                                                                 >> /root/ReglasIPTablesV4RouterEthernetWiFi
          ...
          echo "  pre-up iptables-restore < /root/ReglasIPTablesV4RouterEthernetWiFi" >> /etc/network/interfaces
  ...
  echo ""
  echo "---------------------------------------------------------------------------------------"
  echo "  Iniciando el script de preparación de Debian 10 (Buster) para que routee por br0..."
  echo "---------------------------------------------------------------------------------------"
  echo ""
  ...
  echo ""
  echo "-----------------------------------------------------------------------------------------"
  echo "  Iniciando el script de preparación de Debian 11 (Bullseye) para que routee por br0..."
  echo "-----------------------------------------------------------------------------------------"
  echo ""
