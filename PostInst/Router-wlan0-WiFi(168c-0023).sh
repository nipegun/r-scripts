...
#  FAZ CABLEADA Y UNA INTERFAZ INALÁMBRICA ATHEROS AR9285.
...
#
#  La tarjeta sólo la he logrado hacer funcionar en modo 2,4GHz n
#-------------------------------------------------------------------
...
do
  case $choice in
    ...
    4)
      ...
      echo "ht_capab=[HT20+][HT40+][SHORT-GI-40][MAX-AMSDU-3939][DSSS_CCK-40]"                    >> /etc/hostapd/hostapd.conf
      echo "#No RX STBC, ni idea como se pone en capability ht"                                   >> /etc/hostapd/hostapd.conf
