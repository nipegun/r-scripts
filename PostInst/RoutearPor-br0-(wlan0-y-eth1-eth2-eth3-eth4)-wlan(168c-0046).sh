...
#
#  Ejecución remota:
#  curl -s "https://raw.githubusercontent.com/nipegun/r-scripts/master/PostInst/RoutearPor-br0-(wlan0-y-eth1-eth2-eth3-eth4)-wlan(168c-0046).sh" | bash
# ----------
...
#  Es necesario que el ordenador cuente con, al menos, una interfaz cableada y una interfaz inalámbrica Atheros QCA9984.
    ...
    do
      case $choice in
        ...
        4)
          ...
          echo ""                                                                                                                                                                                            >> /etc/hostapd/hostapd.conf
          echo "#Tarjeta Compex WLE1216v5-20 Atheros QCA9984/QCA9994 (168c:0046)"                                                                                                                            >> /etc/hostapd/hostapd.conf
