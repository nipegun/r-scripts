...
if [ $OS_VERS == "13" ]; then
  ...
  echo ""
  echo -e "${cColorAzul}  Iniciando el script de preparación de Debian 13 () como router por eth1...${cFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${cColorAzul}  Iniciando el script de preparación de Debian 12 (Bookworm) como router por eth1...${cFinColor}"
  echo ""
      ...
      do
        case $choice in
          ...
          1)
            ...
            echo ""
            echo -e "${cColorAzulClaro}  Configurando tarjetas de red...${cFinColor}"
            echo ""
          ...
          2)
            ...
            echo ""
            echo -e "${cColorAzulClaro}    Habilitando el forwarding entre interfaces...${cFinColor}"
            echo ""
          ...
          3)
            ...
            echo ""
            echo -e "${cColorAzulClaro}  Agregando la funcionalidad NAT...${cFinColor}"
            echo ""
          ...
          4)
            ...
            echo ""
            echo -e "${cColorAzulClaro}  Agregando la funcionalidad DHCP...${cFinColor}"
            echo ""
          ...
          5)
            ...
            echo ""
            echo -e "${cColorAzulClaro}  Agregando la funcionalidad DNS...${cFinColor}"
            echo ""
  ...
  echo ""
  echo -e "${cColorAzul}  Iniciando el script de preparación de Debian 11 (Bullseye) como router por eth1...${cFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${cColorAzul}  Iniciando el script de preparación de Debian 10 (Buster) como router por eth1...${cFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${cColorAzul}  Iniciando el script de preparación de Debian 9 (Stretch) como router por eth1...${cFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${cColorAzul}  Iniciando el script de preparación de Debian 8 (Jessie) como router por eth1...${cFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${cColorAzul}  Iniciando el script de preparación de Debian 7 (Wheezy) como router por eth1...${cFinColor}"
  echo ""
