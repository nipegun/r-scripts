...
# ----------
#  Script de NiPeGun para preparar un Armbian recién instalado en un NanoPi R2S
...
if [ $OS_VERS == "7" ]; then
  ...
  echo ""
  echo "-----------------------------------------------------------------------------------"
  echo "  Iniciando el script para conectar Debian 10 (Buster) con la ONT de Movistar...."
  echo "-----------------------------------------------------------------------------------"
  echo ""
