...
#  FAZ CABLEADA Y UNA INTERFAZ INALÁMBRICA BROADCOM BCM4321.
...
#
#  La tarjeta sólo la he logrado hacer funcionar en modo 2,4GHz g
#-------------------------------------------------------------------
...
do
  case $choice in
    ...
    3)
      ...
      echo "---------------------------------"
      echo ""
      apt-get -y install isc-dhcp-server hostapd crda firmware-b43-installer
    ;;
    ...
    4)
      ...
      echo "ht_capab=[RX-STBC2]" >> /etc/hostapd/hostapd.conf
