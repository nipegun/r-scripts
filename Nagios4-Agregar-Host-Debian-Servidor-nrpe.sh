...
# Controlar que la cantidad de argumentos ingresados sea la correcta
  if [ $# -ne $cCantArgumEsperados ]
    then
      ...
      echo ""
      echo "  Host agregado."
      echo "  Si la monitorización no funciona comprueba que en el host estén instalados los siguientes paquetes:"
      echo ""
      echo "    apt-get -y install nagios-nrpe-server"
      echo "    apt-get -y install monitoring-plugins"
      echo "    apt-get -y install monitoring-plugins-contrib"
      echo ""
