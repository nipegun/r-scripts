...
#
# Ejecución remota:
#  curl -sL https://raw.githubusercontent.com/nipegun/r-scripts/master/Nagios4-Agregar-Host-Router-Cisco.sh | bash -s URL Servicio
#
#  Ejemplo:
#  curl -sL https://raw.githubusercontent.com/nipegun/r-scripts/master/Nagios4-Agregar-Host-Router-Cisco.sh | bash -s mirouter "Mi router" "192.168.0.123"
# ----------
