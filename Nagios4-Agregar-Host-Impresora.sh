...
#
# Ejecución remota:
#  curl -sL https://raw.githubusercontent.com/nipegun/r-scripts/master/Nagios4-Agregar-Host-Impresora.sh | bash -s URL Servicio
#
#  Ejemplo:
#  curl -sL https://raw.githubusercontent.com/nipegun/r-scripts/master/Nagios4-Agregar-Host-Impresora.sh | bash -s midebianserver "Mi servidor Debian" "192.168.0.123"
# ----------
